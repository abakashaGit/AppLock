package com.pattern.activity.util;
...
import com.pattern.activity.LockPatternView;
...
public int comparePattern(List<LockPatternView.Cell> pattern1,List<LockPatternView.Cell> pattern2) {

    String  ptrn_one = patternToString(pattern1);
    String  ptrn_two = patternToString(pattern2);
    return ptrn_one.equals(ptrn_two) ? 1 : 0;
